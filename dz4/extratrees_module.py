...
def train_et_model(df, test_size=0.2, random_state=42):
    ...
    # Создаем и обучаем модель ExtraTreesClassifier
    ...
    return et_model, label_encoders  # Возвращаем обученную модель и label encoders